...
filtered_data <- pca_merged_with_dat[, (missing_percentage < 44) | (names(pca_merged_with_dat) == "DIAHBRSK") | (names(pca_merged_with_dat) == "GLUCFPD") | (names(pca_merged_with_dat) == "TRIGNTR") | (names(pca_merged_with_dat) == "HCHOLBC ")]
...
plot_lm_model(PHDCMWBC ~ PC1 + PC2 + PC3 + PC4,  cleaned_pca_merged, "PHDCMWBC")  # Waist Circumference
plot_lm_model(PHDKGWBC ~ PC1 + PC2 + PC3 + PC4, cleaned_pca_merged, "PHDKGWBC")  # Weight
plot_lm_model(SYSTOL ~ PC1 + PC2 + PC3 + PC4, cleaned_pca_merged, "SYSTOL")      # Systolic Blood Pressure
plot_lm_model(DIASTOL ~ PC1 + PC2 + PC3 + PC4 , cleaned_pca_merged, "DIASTOL")    # Diastolic Blood Pressure
